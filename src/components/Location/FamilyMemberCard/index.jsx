		...
		<div id={`${id}`}>
			<div className='member    flex flex-col md:flex-row md:h-28 '>
				<div className='member-info   w-full  xl:w-11/12 '>
					...
					<div className='member-other-details flex flex-col md:flex-row md:h-1/2 py-2 '>
						<div className=''>
				...
				<div
					...
					className=' text-red-500 cursor-pointer pt-3 md:pt-0   md:w-1/12 flex justify-center items-center  '>
					<svg
			...
			<div className='border-b-2 my-4 md:my-10 border-black '></div>
		</div>
	);
};
