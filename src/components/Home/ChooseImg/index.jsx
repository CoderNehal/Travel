...
const Box = () => {
	return (
		<div className='w-screen -mt-20 lg:-mt-4  -ml-1 h-96 lg:h-48rem relative'>
			<div className='light h-1/2 w-full pl-1 flex justify-center '>
				<img
					className=' -ml-1 object-cover  w-full px-6 lg:px-12 h-full lg:h-150  mt-28 lg:mt-24'
					src={tent}
					alt=''
				/>

				<div className='title absolute text-2xl lg:text-6xl text-white bottom-24 lg:bottom-44 flex flex-col  items-center'>
